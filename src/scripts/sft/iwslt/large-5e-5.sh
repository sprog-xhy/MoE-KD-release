...
MODEL_PATH=${ROOT_DIR}/results/sft/iwslt/gpt2/large_[lr5e-5]_sft_20240321_153953/ckpt/step_36000_ppl_2.98
DATA_PATH=${ROOT_DIR}/dataset/iwslt2017
OUTPUT=${ROOT_DIR}/results/sft/iwslt/gpt2/large_[lr5e-5]_sft_${DATETIME}
BATCH_SIZE=64
