...
TEACHER_PATH=${ROOT_DIR}/results/sft/iwslt/gpt2/large_[lr5e-5]_sft_20240321_153953/ckpt/step_36000_ppl_2.98
DATA_PATH=${ROOT_DIR}/dataset/iwslt2017
OUTPUT=${ROOT_DIR}/results/sft/iwslt/gpt2/moe_kd_[lr5e-5]_[lm0.1]_${DATETIME}
BATCH_SIZE=32
...
OPTS+=" --per_device_eval_batch_size $((2 * ${BATCH_SIZE}))"
