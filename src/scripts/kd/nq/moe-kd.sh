...
MODEL_PATH=${ROOT_DIR}/results/sft/nq/gpt2/moe_small_[lr5e-5]_sft_20240324_213734/ckpt/step_2000_ppl_30.27
...
OUTPUT=${ROOT_DIR}/results/sft/nq/gpt2/moe_kd_[lr5e-5]_[lm0.1]_${DATETIME}
BATCH_SIZE=32
