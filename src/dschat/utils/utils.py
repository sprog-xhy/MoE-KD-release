...
def save_hf_format(model, tokenizer, output_dir, sub_folder="", is_lora=False):
    ...
    # if hasattr(model_to_save.config, "_name_or_path"):
    #     del model_to_save.config['_name_or_path']
...
def get_optimizer_grouped_parameters(
    ...
    # print("---------------------------------------------------------")
    # print("----------------- optimizer_group_1 --------------------")
    # print("---------------------------------------------------------")
    # group1 = [n for n, p in model.named_parameters()
    ...
    #     print(x)
    # print("---------------------------------------------------------")
    # print("----------------- optimizer_group_2 --------------------")
    # print("---------------------------------------------------------")
    # group2 = [n for n, p in model.named_parameters()
    #           if (not any(nd in n.lower() for nd in no_decay_name_list)
    ...
    #
    # print("---------------------------------------------------------")
    # print("----------------- optimizer_group_3 --------------------")
    # print("---------------------------------------------------------")
    # group3 = [p for n, p in model.named_parameters()
